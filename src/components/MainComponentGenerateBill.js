...
import GenerateBillComponent from '../pages/GenerateBillComponent';
import Sidebar from './Sidebar';
import GoogleFontLoader from 'react-google-font-loader'
import 'adminbsb-materialdesign/css/themes/all-themes.css';

class MainComponentGenerateBill extends React.Component{
    state={
...
export default MainComponentGenerateBill;
        ...
        <aside id="leftsidebar" className="sidebar">
            ...
            <div className="user-info">
                ...
                <div className="info-container">
                    <div className="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Chapal Shaik </div>
                    <div className="email">shaikchapal@example.com</div>
            ...
            <div className="menu">
                ...
                <div className="slimScrollBar" 
                    ...
                    style={{width: "4px", height: "100%", position: "absolute", top: "0px", display: "none", borderRadious: "0px", background: "rgb(51, 51, 51)", opacity: "0.2", zIndex: "90", right: "1px"}}>
